...
import com.jodli.projectled.activity_pattern;
...
public class RpcHandler {
    ...
    public static void CallRPCLedOn(String ip, int ledpin, final activity_pattern liveactivity){
    ...
    public static void CallRPCLedOff(String ip, int ledpin, final activity_pattern liveactivity){
